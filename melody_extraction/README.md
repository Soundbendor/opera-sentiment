# All codes in this folder are from the repository of "A Streamlined Encoder/Decoder Architecture for Melody Extraction", all rights reserved to the original authors.
